...
const defaultItems: TiltedScrollItem[] = [
  { id: "1", text: "Capture Site Photos" },
  { id: "2", text: "Add Voice Notes" },
  { id: "3", text: "Mark Issues" },
  { id: "4", text: "Track Progress" },
  { id: "5", text: "Generate Reports" },
  { id: "6", text: "Collaborate" },
  { id: "7", text: "Export Data" },
  { id: "8", text: "Stay Organized" },
] 